...
class Balance(models.Model):
    wallet = models.ForeignKey(CustomUser, related_name='wallet', on_delete=models.CASCADE)
    ...
    coin_ticker = models.ForeignKey(CoinTicker, related_name='symbol', on_delete=models.CASCADE)#moneda
